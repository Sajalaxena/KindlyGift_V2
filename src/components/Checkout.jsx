...
export default function Checkout({ onClose, onOrderSuccess }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-200 via-rose-200 to-purple-200">
      {/* Header */}
      <div className="bg-[#d65a8d] text-white p-4 sticky top-0 z-40 shadow-lg">
            ...
            {cart.length === 0 ? (
              ...
              <>
                      ...
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-600 text-sm mt-1">
                            Quantity: <span className="font-semibold text-[#d65a8d]">{item.qty}</span>
                          </p>
                          <p className="text-gray-600 text-sm">
                            Per Unit Price: <span className="font-semibold">₹{item.salePrice}</span>
                          </p>
                          <p className="text-[#d65a8d] font-bold text-lg mt-2">
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                  ...
                  <div className="border-t border-gray-300 pt-3 flex justify-between font-bold text-lg text-[#d65a8d]">
                    <span>Total:</span>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <input
                ...
                className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d65a8d] transition-all"
              />
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows="4"
                className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d65a8d] transition-all resize-none"
              />
              ...
              <button
                ...
                className="w-full bg-[#d65a8d] text-white py-4 rounded-lg font-bold text-lg hover:bg-[#b03a6b] disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors mt-8 cursor-pointer"
              >
